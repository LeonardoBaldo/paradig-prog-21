package br.com.unifacef.lista3.exe01;
...
public class Cartao {
    ...
    public void mostra()
    {
        System.out.println("Número: " + this.numero + " Senha: " + this.senha + 
                            " Validade: " + this.validade + " Bandeira " + 
                             this.bandeira + " CVV " +  this.cvv);
        this.conta.mostra();
    }
        // sacar
    public void sacar(float valor, int senha)
    {
        ...
        // senha do cartão é a mesma informada pelo usuário?
        if (this.senha == senha) // verifica a senha do cartão
        {
            // data do saque
            Date agora = new Date();
